...
default["bcpc"]["hadoop"]["hbase"]["region.replication.enabled"] = true
...
default[:bcpc][:hadoop][:hbase][:site_xml].tap do |site_xml|
  ...
  site_xml['hbase.regionserver.storefile.refresh.all'] = false
  site_xml['hbase.region.replica.storefile.refresh.memstore.multiplier'] = 4
  site_xml['hbase.region.replica.wait.for.primary.flush'] = true
  site_xml['hbase.regionserver.global.memstore.lowerLimit'] = 0.2
  site_xml['hbase.hregion.memstore.block.multiplier'] = 8
  site_xml['hbase.ipc.client.specificThreadForWriting'] = true
  site_xml['hbase.client.primaryCallTimeout.get'] = 100000
  site_xml['hbase.client.primaryCallTimeout.multiget'] = 100000
end
